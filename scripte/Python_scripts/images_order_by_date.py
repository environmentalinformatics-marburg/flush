...
from mercurial.util import copyfile
...
parser.add_option('-s', '--source', 
                  dest = "source", 
                  default = "/home/eikistations/ei_data_kilimanjaro/processing/tlc/incoming/20120710-20120814/",
                  )
parser.add_option('-d', '--dest', 
                  dest = "dest", 
                  default = "/home/eikistations/ei_data_kilimanjaro/processing/tlc/rename_order_by_date/",
                  )
