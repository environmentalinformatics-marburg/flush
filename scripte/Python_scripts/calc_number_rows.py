...
"""
    ...
    print
    stations_dataset=sorted(locate("*","*", options.path))
    ...
    rowNumberAEMU = 0
    rowNumberEEMU = 0
    output_path = options.path + "colum_numbers_" +  options.station + ".txt"
    fileout = open(output_path, "w")
    date = ""
    for dir in os.listdir(options.path):
        station_dataset=sorted(locate("*" + options.file, "*" + options.station +"*", options.path + dir))
        fileout.write("\n")
        fileout.write(dir)
        fileout.write("\n")
        ...
        print "CEMU"
        print rowNumberCEMU
        fileout.write("CEMU " + str(rowNumberCEMU) + ",")
        fileout.write("\n")
        print "AEMU"
        print rowNumberAEMU
        fileout.write("AEMU " + str(rowNumberAEMU) + ",")
        fileout.write("\n")
        print "EEMU"
        print rowNumberEEMU
        fileout.write("EEMU " + str(rowNumberEEMU) + ",")
        fileout.write("\n")
    fileout.close()
