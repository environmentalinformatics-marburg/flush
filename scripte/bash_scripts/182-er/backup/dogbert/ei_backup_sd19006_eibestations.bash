...
# Crontab entry: 0 1 * * * bash /home/dogbert/administration/backup/ei_backup_sd19006_eibestations.bash >> /home/dogbert/administration/backup/log_error_sd19006_eibestations.log 2>&1 &

SOURCEPATH='/home/eibestations/ei_data_exploratories/' 
BACKUPPATH='/mnt/sd19003/sd19006_backup_exploratories/'
BACKUPNAME='sd19006_backup_exploratories'
...
if ping -qc 20 192.168.191.180 >/dev/null; then
	...
	# Check if backup errors
		if less  ${LOGPATH}log_rsync_sd19006_backup_exploratories.log | grep error ; then 
				java -jar ${LOGPATH}sender.jar spaska.forteva@geo.uni-marburg.de forteva@staff.uni-marburg.de smtp.staff.uni-marburg.de Backup "Backup sd19006_backup_exploratories: Error messages" 
