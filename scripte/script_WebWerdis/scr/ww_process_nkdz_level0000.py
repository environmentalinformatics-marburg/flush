...
def main():
    ...
    parser.add_option("-p", "--pla", dest="top_level_station_path", \
        default = "/media/dogbert/dev/be/WebWerdis/Stationen", \
    ...
    for station_id in a.next()[1]:
        ...
        station_id = station_id.capitalize()
        print station_id
        ...
        if p_exists:
            ...
            for row in data_2:
                ...
                try:
                    ...
                    try:
                        if "latitude" in row:
                            row_coord = row.split("latitude")[1]
                            coord.append([date, row_coord.split('"')[1], row_coord.split('"')[3], row_coord.split('"')[5]])
                    except:
                       continue                  
                except:
                    continue
